...
func main() {
	...
	route.HandleFunc("/product/user/{userId}", app.ProductHandler.GetProductByUserId).Methods("GET")
	route.HandleFunc("/product", app.ProductHandler.CreateNewProduct).Methods("POST")
